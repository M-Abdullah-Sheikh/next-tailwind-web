  ...
  return (
    <div className={shadow ? 'fixed w-full h-20 shadow-xl z-[100]' : 'fixed w-full h-20 z-[100]'}>
      <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16 bg-white'>
        <Image src="/assest/panaverse-logo.png" alt="/" width='125' height='50' />
        ...
        <div className={nav ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500' : 'fixed left-[100%] top-0  p-10 ease-in duration-500'}>
          <div>
            <div className='flex w-full items-center justify-between'>
              <Image src="/assest/panaverse-logo.png" alt="/" width='87' height='35' />
          ...
          <div className='py-4 flex flex-col'>
            ...
            <div className='pt-40'>
              <p className='uppercase tracking-widest text-[#d20f2d]'>Lets Connect</p>
